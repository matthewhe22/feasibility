...
export const defaultDevelopmentCosts: CostLineItem[] = [
  ...
  dc('2005', 'Council Fees **NO GST**', 750846, false),
  ...
  dc('2028', 'NBN', 171446),
  dc('2029', 'Open Space Levy **NO GST**', 0, false),
  ...
  dc('2060', 'Bank Fees *** NO GST ***', 0, false),
  dc('2061', 'Property Shell', 0),
  dc('2062', 'Council rates *** NO GST ***', 1275567, false),
  dc('2063', 'Disbursements on Settlement', 205500),
  dc('2064', 'Other Bonus *** NO GST ***', 0, false),
  dc('2065', 'KPI *** NO GST ***', 0, false),
  dc('2066', 'Communal Furniture', 1090909),
  dc('2067', 'Land Tax *** NO GST ***', 0, false),
