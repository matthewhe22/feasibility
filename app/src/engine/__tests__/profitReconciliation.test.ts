...
function profitableInputs(): MainInputs {
  return {
    ...
    equityDeveloper: { name: 'Dev', equityCap: 15_000_000, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: 15_000_000, profitShare: 1, drawdownPriority: 1 },
