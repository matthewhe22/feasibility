...
function fixture(opts: { gstIncluded?: boolean; revenueType?: string; settled?: boolean; mezzBBSY?: number; mezzMargin?: number } = {}): MainInputs {
  return {
    ...
    equityDeveloper: { name: 'D', equityCap: 12_000_000, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: 12_000_000, profitShare: 1, drawdownPriority: 1 },
