...
function fixture(opts: {
  ...
  return {
    ...
    equityDeveloper: { name: 'D', fixedAmount: opts.equity, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: opts.equity, profitShare: 1, drawdownPriority: 1 },
