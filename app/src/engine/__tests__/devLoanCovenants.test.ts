...
function makeInputs(seniorType: FacilityType | undefined): MainInputs {
  ...
  return {
    ...
    equityDeveloper: { name: 'Dev', fixedAmount: 6_000_000, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: 6_000_000, profitShare: 1, drawdownPriority: 1 },
