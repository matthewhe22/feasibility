...
function fixture(): MainInputs {
  return {
    ...
    equityDeveloper: { name: 'D', fixedAmount: 2_000_000, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: 2_000_000, profitShare: 1, drawdownPriority: 1 },
