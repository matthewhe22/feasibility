...
function fixture(): MainInputs {
  return {
    ...
    seniorFacility: { name:'S', facilityLimit:8_000_000, startMonth:1, maturityMonth:24, interestRate:0, bbsy:0.04, margin:0.04, establishmentFeePercent:0, lineFeePercent:0, interestPaymentFrequency:1, isCapitalised:true, ltcTarget:0.45, lvrTarget:0.45, drawdownPriority:2 },
