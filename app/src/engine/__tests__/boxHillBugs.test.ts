...
function makeMarginSchemeInputs(opts: { landLoanBBSY?: number; landLoanMargin?: number; sale?: number; equity?: number }): MainInputs {
  ...
  return {
    ...
    equityDeveloper: { name: 'Dev', equityCap: equity, percentage: 1, interestRate: 0, interestCompound: 0, repayEquityBeforeDebt: 0, equityContribution: equity, profitShare: 1, drawdownPriority: 1 },
